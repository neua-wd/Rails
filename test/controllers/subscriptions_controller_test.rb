...
class SubscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscription" do
    assert_difference('Subscription.count') do
      post subscriptions_url, params: { subscription: { course_id: @subscription.course_id, user_id: @subscription.user_id } }
    end
  ...
  test "should update subscription" do
    patch subscription_url(@subscription), params: { subscription: { course_id: @subscription.course_id, user_id: @subscription.user_id } }
