...
class StudentProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_profile" do
    assert_difference('StudentProfile.count') do
      post student_profiles_url, params: { student_profile: { citizen_id: @student_profile.citizen_id, first_name: @student_profile.first_name, last_name: @student_profile.last_name, student_id: @student_profile.student_id, user_id: @student_profile.user_id } }
    end
  ...
  test "should update student_profile" do
    patch student_profile_url(@student_profile), params: { student_profile: { citizen_id: @student_profile.citizen_id, first_name: @student_profile.first_name, last_name: @student_profile.last_name, student_id: @student_profile.student_id, user_id: @student_profile.user_id } }
